            ...
            {rows
              ...
              .map((row) => (
                <TableRow hover key={row.id} className={classes.row}>
                  <TableCell className={classes.cell} style={{ padding: 0 }} align="center" >
                    <Checkbox color="primary"/>
                  </TableCell>
                  <TableCell className={classes.cell} style={{ width: 340 }} align="center">
                    {row.ref}
                  </TableCell>
                  <TableCell className={classes.cell} style={{ width: 250 }} align="center">
                    {row.order_ref}
                  </TableCell>
                  <TableCell className={classes.cell} style={{ width: 220 }} align="center">
                    {row.quantity}
                  </TableCell>
                  <TableCell className={classes.cell} style={{ width: 220, padding: 0 }} align="center">
                    <TextField
                      type="number"
